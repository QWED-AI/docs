...
sidebar_position: 2
title: The 10 Guards
description: "QWED-Finance verification guards including ComplianceGuard (Z3 for AML/KYC), CalendarGuard, DerivativesGuard, MessageGuard, and QueryGuard with code examples."
---
...
:::tip PyPI Package
All 10 guards are available via `pip install qwed-finance`
:::
