---
sidebar_position: 1
title: "QWED Finance: deterministic verification for financial AI"
sidebarTitle: "Overview"
description: "QWED Finance uses deterministic verification, SymPy, and Z3 to prevent hallucinations in financial AI, agent workflows, and transaction calculations."
---
...
> **New in v2.1.0:** Security audit hardening — fail-closed enforcement across `OpenResponsesIntegration`, full `Decimal`/`mpmath` migration in `BondGuard`, `DerivativesGuard`, and `RiskGuard`, and `verify_compound_interest` now raises on unknown frequencies. See the [v2.1.0 changelog entry](/changelog#qwed-finance--v2-1-0-security-audit-hardening) for migration notes.
...
- [Compliance & Auditing](/finance/compliance) - Receipts and regulatory proof
