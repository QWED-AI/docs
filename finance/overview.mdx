...
sidebar_position: 1
title: Overview
description: "QWED-Finance is a guardrail library for financial AI using SymPy and Z3 to prevent LLM hallucinations. Features 9 specialized guards for compliance and calculations."
---
...
- [The 5 Guards](/finance/guards) - Deep dive into each verification guard
- [Compliance & Auditing](/finance/compliance) - Receipts and regulatory proof
- [Integrations](/finance/integrations/ucp) - Connect with UCP and Open Responses
