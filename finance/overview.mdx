...
sidebar_position: 1
title: Overview
description: "QWED-Finance is a guardrail library for financial AI using SymPy and Z3 to prevent LLM hallucinations. Features 10 specialized guards for compliance and calculations."
---
...
flowchart TB
    ...
    subgraph QWED["🛡️ QWED-Finance v2.0.1"]
        direction TB
