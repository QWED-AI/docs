...
description: "Use QWEDVerifiedAgent and QWEDVerificationTool with CrewAI for verified multi-agent systems. Ensure agent outputs are mathematically correct before execution."
---
