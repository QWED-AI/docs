...
description: Use VerifiedOpenAI wrapper to automatically verify OpenAI SDK responses with QWED guards. Drop-in replacement for the OpenAI Python client with verification.
---
