...
<Info>
This fail-closed behavior shipped in v5.1.0. See the [changelog](/changelog#v510--agent-state-governance-and-fail-closed-hardening) for the full release notes.
</Info>
