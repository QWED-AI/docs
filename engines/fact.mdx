...
sidebar_position: "6"
title: "Fact Engine"
description: "QWED's Fact Engine verifies claims using TF-IDF similarity, keyword overlap, entity matching, and negation detection without requiring LLM calls for most claims."
---
