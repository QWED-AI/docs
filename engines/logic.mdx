...
sidebar_position: "3"
title: "Logic Engine"
description: "QWED's Logic Engine uses Microsoft's Z3 SMT solver for satisfiability checking, model finding, proof generation, and quantifier support with secure S-expression DSL."
---
