...
description: "Learn the correct QWED integration pattern: route LLM calls through QWED so DSL enforcement, guard evaluation, and verification receipts work end to end."
---
