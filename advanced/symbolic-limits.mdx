...
description: "CrossHair symbolic execution limits in QWED — path explosion, deep loops, recursion, bounded model checking, and DiagnosticResult fail-closed semantics."
