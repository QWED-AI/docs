...
### 3. Security
- [ ] **Set `API_KEY_SECRET`**: Generate a strong secret — the server will not start without it.
- [ ] **Set `QWED_CORS_ORIGINS`**: Restrict to your application domains — the server will not start without it.
