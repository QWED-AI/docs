...
description: "How QWED verifies LLM outputs against developer-written specifications, plus the golden rule and DSL patterns for reliable, production-ready verification."
