---
title: "QWED Security GitHub App: deterministic PR verification"
description: "Install the QWED Security GitHub App for deterministic, fail-closed security scanning of pull requests, gating merges on a proof-bound ADMIT verdict."
---
...
You can open the rule definition for each finding from its check-run annotation: see the [QWED Security rule catalog](/advanced/qwed-security-rule-catalog) for rule IDs, matched patterns, and trip and pass examples.
