...
1. Visit the [QWED Security App](https://github.com/apps/qwed-security)
2. Click **Install**
3. Select the repositories you want to protect
4. Done — QWED Security will automatically scan new Pull Requests

<Tip>
  **QWED Security** is a **Verified Publisher** on [GitHub Marketplace](https://github.com/marketplace/qwed-security). Install it to auto-verify every PR with deterministic math, logic, and security checks.
</Tip>
