...
Every finding links to its rule definition in the [QWED Security rule catalog](/advanced/qwed-security-rule-catalog) — rule ID, matched pattern, trip and pass examples.
