---
title: "QWED design decisions"
description: "QWED's core design philosophy and the Untrusted Translator pattern for deterministic verification of LLM outputs."
---
...
- Cons: Steep learning curve, you need solver expertise
...
**Why this matters:** helps you understand QWED's scope
...
2. **More domain tutorials:** you asked for more examples per domain
