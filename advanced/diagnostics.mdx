...
description: "The 3-layer QWED DiagnosticResult model: agent-safe, developer, and proof diagnostics for structured verification output, debugging, and audit logs."
---
...
<CardGroup cols={2}>
  ...
  <Card title="QWED Legal diagnostics" icon="scale-balanced" href="/legal/overview">
    Per-guard `VERIFIED` / `UNVERIFIABLE` / `BLOCKED` mapping and `proof_ref` semantics for the legal guards.
  </Card>
</CardGroup>
