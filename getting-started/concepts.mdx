...
sidebar_position: 3
title: "Core Concepts"
description: "Understand QWED's trust model philosophy. LLMs are probabilistic translators, not reasoning engines. Learn how QWED verifies translations deterministically."
---
...
- [Attestation Spec](/specs/attestation)
- [Agent Spec](/specs/agent)
