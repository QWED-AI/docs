---
sidebar_position: "9"
title: Taint Analysis Engine
description: QWED's Taint Analysis Engine tracks untrusted user input through code to prevent it from reaching sensitive sinks without sanitization. Critical for LLM security.
---
