...
description: QWED-Finance system architecture with C4 Context and Component diagrams showing integration with banking systems, SWIFT, and regulators as verification middleware.
---
...
* [The 5 Guards](/finance/guards) — Guard implementation details
