...
description: "QWED-UCP 10 verification guards including Money Guard (verifies cart totals), State Guard (validates checkout state transitions), Refund Guard, Tip Guard, Fee Guard, and Attestation Guard. Complete reference with examples."
---
