...
description: "QWED-UCP 6 verification guards including Money Guard (verifies cart totals) and State Guard (validates checkout state transitions). Complete reference with examples."
---
