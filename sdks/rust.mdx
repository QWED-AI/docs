...
sidebar_position: "5"
title: "Rust SDK"
description: "QWED Rust SDK documentation. Add via Cargo, use async/await with tokio runtime, and integrate deterministic verification into your Rust applications."
---
# Rust SDK
