...
sidebar_position: 3
title: Examples
description: "Real-world QWED-Legal examples including employment contract deadline verification and SaaS liability cap calculations with Python code samples."
---
