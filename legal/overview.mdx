...
description: "QWED Legal is a deterministic rejection layer for computational legal claims. It verifies dates, amounts, and structured constraints, and fails closed when proof is not possible."
---
