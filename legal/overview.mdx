...
| `ClauseGuard` | Z3 SAT proves constraints satisfiable (no contradiction over modeled constraints) | Heuristic pass over `INFERRED` evidence | Deterministic contradiction (Z3 UNSAT, or modeled heuristic conflict) |
...
| `ContradictionGuard` | Z3 SAT over modeled clause categories (consistent) | Unmodeled clause categories | Z3 UNSAT (contradiction) or explicit modeled conflict |
