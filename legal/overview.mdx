...
| **ClauseGuard** | Text heuristics + Z3 | Text-based contradiction detection with optional Z3 verification |
| **CitationGuard** | Regex patterns | US, UK, and India citation format validation |
...
| **IRACGuard** | Regex patterns | Legal reasoning structure verification |
| **FairnessGuard** | Counterfactual testing | Algorithmic bias detection |
| **ContradictionGuard** | Z3 SMT Solver | Formal logic contradiction verification |
| **ProvenanceGuard** | SHA-256 + regex | AI content provenance and disclosure compliance |
