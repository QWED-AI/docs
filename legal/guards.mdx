...
sidebar_position: 2
title: The 6 Guards
description: "QWED-Legal guards: DeadlineGuard (business days, holidays), LiabilityGuard, ClauseGuard (Z3 for contradictions), CitationGuard, JurisdictionGuard, StatuteOfLimitationsGuard."
---
