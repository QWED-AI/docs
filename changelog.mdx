...
See [Security hardening — Secret-scanning webhook intake](/advanced/security-hardening#7-secret-scanning-webhook-intake) for the full trust model and operator configuration.
