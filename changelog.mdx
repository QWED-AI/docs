...
**Jump to:** [v5.1.0](#v510--agent-state-governance-and-fail-closed-hardening) · [v5.0.0](#v500--enforcement-boundary-hardening) · [v4.0.5](#v405--stats-exception-masking) · [v4.0.4](#v404--fail-closed-execution-enforcement) · [v4.0.3](#v403--server-enforced-agent-security) · [v4.0.2](#v402--security-cleanup) · [v4.0.1](#v401--sentinel-guard-sync) · [v4.0.0](#v400--sentinel-edition) · [v3.0.1](#v301--ironclad-update) · [v2.4.1](#v241--the-reasoning-engine)
