...
<Card title="v4.0.1 — Sentinel Guard Sync 🔄" icon="arrows-rotate" href="/changelog">
  Patch release — TypeScript SDK alignment, new `/verify/process` endpoint, agent security checks, and security fixes.
</Card>
...
```bash go
go get github.com/QWED-AI/qwed-verification/sdk-go@v4.0.1
```
...
<Accordion title="v4.0.1 — Sentinel Guard Sync (March 23, 2026)" icon="arrows-rotate" defaultOpen>
