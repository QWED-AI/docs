...
<Card title="v5.1.1 — Trust Boundary Hardening" icon="shield-check" href="/changelog">
  Cache trust-context binding (replay resistance), attestation fail-closed hardening, audit log isolation, proof-path corrections, and agent/executor boundary fixes.
</Card>
...
<Accordion title="v5.1.1 — Trust Boundary Hardening (May 22, 2026)" icon="shield-check" defaultOpen>
