---
title: "QWED Protocol releases — SDK versions and install downloads"
...
<Card title="v7.0.0 — Full DiagnosticResult Engine Conformance" icon="shield-check" href="/changelog#v7-0-0--full-diagnosticresult-engine-conformance">
