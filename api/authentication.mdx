...
QWED issues new keys in the v2 format. Existing v1 keys keep working and are never force-rotated.
...
- [`spec/api-key-test-vectors.json`](https://github.com/QWED-AI/qwed-verification/blob/main/spec/api-key-test-vectors.json): synthetic, non-functional valid and invalid keys with expected classifications (`v2`, `v1`, or `invalid`). None of these values authenticate.
