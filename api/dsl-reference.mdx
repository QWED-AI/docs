---
sidebar_position: 5
title: "QWED-Logic DSL Reference"
description: "QWED-Logic S-expression DSL reference for logical constraints. Covers basic syntax, operators (AND, OR, NOT, IMPLIES), verified by the Z3 SMT solver."
---
