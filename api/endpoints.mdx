...
sidebar_position: 2
title: "API Endpoints"
description: "Complete QWED API endpoint reference. Includes health check, verification endpoints with auto-detection, math, logic, code, SQL, and batch operations."
---
# API Endpoints
