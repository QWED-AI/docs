...
description: QWED architecture decisions and the Untrusted Translator pattern. LLMs translate natural language to formal specifications, then symbolic solvers verify deterministically.
---
