...
sidebar_position: 1
title: Overview
description: QWED Legal helps you review contracts with deterministic checks for dates, contradictory clauses, liability terms, and citation accuracy using specialized guards.
---
...
## The 9 Guards of Legal Verification
...
| **ClauseGuard**               | Text heuristics            | Text-based contradiction detection               |
...
flowchart TB
    ...
    subgraph QWED["🏛️ QWED-Legal v0.3.0"]
        direction TB
        subgraph Guards["9 Verification Guards"]
...
* [The 9 Guards](/legal/guards) - Deep dive into each verification guard
