...
sidebar_position: 1
title: Overview
description: QWED-Infra for Infrastructure as Code verification using Z3 Solver and Graph Theory. Verify Terraform, AWS IAM, and Kubernetes configurations before deployment.
---
