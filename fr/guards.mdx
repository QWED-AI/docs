...
sidebar_position: 2
title: The 6 Guards
description: QWED Legal guard reference for deadline checks, liability math, clause contradiction detection, citation validation, jurisdiction checks, and limitation-period analysis.
---
