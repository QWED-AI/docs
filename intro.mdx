...
<Note>
**QWED v5.1.0 Agent State Governance** is now live — AgentStateGuard for deterministic state verification, plus fail-closed hardening across math, logic, code execution, and schema validation. [See what's new →](/changelog#v510--agent-state-governance-and-fail-closed-hardening)
</Note>
