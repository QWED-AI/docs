...
<Note>
**QWED v5.0.0 Enforcement Boundary Hardening** is now live — fail-closed verification, deterministic trust boundaries, and agent hardening. [See what's new →](https://docs.qwedai.com/changelog)
</Note>
