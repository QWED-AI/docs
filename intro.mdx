...
<Note>
**QWED v4.0.1 Sentinel Guard Sync** is now live — TypeScript SDK alignment, new verification endpoints, and security fixes. [See what's new →](/changelog)
</Note>
...
> **"Don't fix the liar. Verify the lie."** — QWED verifies outputs, processes, and tool interactions before they enter production. It doesn't reduce hallucinations — it makes them irrelevant.
