...
description: "QWED-Agent v1.1 protocol for AI agents to verify actions before execution. Covers agent registration, tool verification, budget limits, trust levels, and progress-aware doom loop detection."
---
