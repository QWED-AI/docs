...
description: "QWED Verification Context v1.0 defines the atomic record of a verification: the verified object, four context layers, verdict, admission, and the proof_ref evidence commitment."
---
