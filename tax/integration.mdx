...
description: "Verify AI-generated payroll, tax, and withholding payloads with QWED Tax pre-flight middleware before forwarding them to Gusto, Avalara, or Stripe."
---
...
<ResponseField name="checks_not_run" type="string[]">
...
<Tabs>
  <Tab title="Arithmetic verified (still blocked)">
    ```json
    {
