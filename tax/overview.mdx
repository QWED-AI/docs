...
sidebar_position: 1
title: Overview
description: "QWED-Tax pre-flight middleware for AI agents handling payroll and tax. Supports IRS (US) and CBDT (India) rules with multi-step legal reasoning alignment."
---
