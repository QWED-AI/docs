...
sidebar_position: 2
title: The Guards
description: "QWED-Tax guards: US guards (ClassificationGuard for W-2/1099, NexusGuard for sales tax, PayrollGuard for FICA) and India guards (CryptoTaxGuard, GSTGuard, InvestmentGuard)."
---
