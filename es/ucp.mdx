...
description: Integrate QWED-Finance with Universal Commerce Protocol for e-commerce payment verification. Includes capability discovery and .well-known/ucp.json configuration.
---
