...
description: "How QWED separates untrusted LLM translation from deterministic verification and returns proof-backed results."
---
...
```mermaid
flowchart TB
    A[1. API Gateway] --> B[2. Translation Layer]
    B --> C[3. Verification Engines]
    C --> D[4. Security Guards]
    D --> E[5. Attestation and Audit]
```
