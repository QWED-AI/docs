...
description: "Troubleshoot QWED-MCP issues including installation problems, configuration errors, and the v0.2.0 migration from verify_* tools to execute_python_code."
---
