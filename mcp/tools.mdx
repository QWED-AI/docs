...
description: "Complete QWED-MCP verification tools reference. Includes verify_math, verify_sql, verify_logic, and verify_code with detailed parameters and examples."
---
...
bom = generator.generate_manifest(
    ...
    mcp_tools_used=["verify_math", "verify_sql"]
)
...
#   ],
#   "mcp_tools": [
#     {"name": "verify_math", "type": "action_execution"},
#     {"name": "verify_sql", "type": "action_execution"}
#   ]
# }
```
