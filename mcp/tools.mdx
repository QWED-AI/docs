...
description: "Complete QWED-MCP tools reference covering execute_python_code (the unified tool in v0.2.0), deprecated verify_* tools, arguments, and return schemas."
---
