...
description: "QWED MCP is a Model Context Protocol server that brings deterministic verification to Claude Desktop and VS Code via a single execute_python_code tool."
---
