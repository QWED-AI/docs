...
Use QWED-MCP when you need MCP security, tool call verification, and deterministic enforcement around Model Context Protocol actions.
...
| --- | --- | --- |
| [`execute_python_code`](/mcp/tools#execute_python_code) | Subprocess execution | The single entry point for all QWED capabilities. Executes dynamically generated Python code with access to all QWED SDK libraries. |
...
async def main():
    ...
    async with stdio_client(server_params) as (read, write):
        async with ClientSession(read, write) as session:
            ...
            # Output: Available tools: ['execute_python_code']
