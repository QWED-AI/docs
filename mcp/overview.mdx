...
description: "QWED MCP is a Model Context Protocol server that brings deterministic verification tools to Claude Desktop and VS Code."
---
...
4. **Test it!** Ask Claude:
   > "What's the derivative of x^3? Use verify\_math to check."
