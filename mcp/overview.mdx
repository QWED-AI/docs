...
description: "QWED-MCP is a Model Context Protocol server providing deterministic verification tools (math, SQL, logic, code) for Claude Desktop, VS Code, and MCP-compatible AI assistants."
---
