...
|-------|-----------|-------------|
| **1. Schema** | Pydantic `AgentMessage` | Validates sender/receiver IDs, payload type, timestamp. Over HTTP, the authenticated API-key identity overrides `sender_agent_id` before this stage. |
