...
description: "Deep-dive into the QWED A2A interceptor pipeline — data flow, component relationships, and verification sequence."
...
| `logic_assertion` | `logic_guard` | Set-based contradiction detection (P ∧ ¬P) | Deterministic, sorted output |
