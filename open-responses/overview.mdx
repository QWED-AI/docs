...
sidebar_position: 1
title: Overview
description: "QWED Open Responses provides deterministic verification guards for AI agent outputs in OpenAI, LangChain, and LlamaIndex frameworks. Verify before execution."
---
