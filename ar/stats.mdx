...
sidebar_position: "5"
title: Stats Engine
description: QWED's Stats Engine executes statistical queries on tabular data using secure sandboxed execution via Wasm, Docker, or restricted Python environments.
---
