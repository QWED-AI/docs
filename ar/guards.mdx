...
description: "QWED-Infra guards: IamGuard (Z3 for IAM policy verification), NetworkGuard (NetworkX for reachability), and CostGuard for budget enforcement and anomaly detection."
---
