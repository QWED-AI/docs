...
description: Integrate QWED correctly by letting it handle LLM calls directly. Avoid the common mistake of calling the LLM yourself then verifying, which fails DSL enforcement.
---
