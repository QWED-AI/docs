---
id: whitepaper
title: "QWED Protocol: deterministic verification for LLMs"
description: "Academic whitepaper on QWED's formal methods approach to eliminating AI hallucinations. Benchmarks show 100% error detection with 73-85% LLM accuracy."
