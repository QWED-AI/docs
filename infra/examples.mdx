...
description: "QWED-Infra code examples for parsing Terraform, verifying IAM policies with context-aware checks, and cloud cost budget verification with Python samples."
---

## 1. Parsing and verifying IAM
