...
description: "Reference for IamGuard, NetworkGuard, and CostGuard — the three QWED-Infra guards for IAM, network, and budget verification."
---
...
CostGuard estimates the monthly cost of your infrastructure definition _before_ deployment. It uses an embedded, static pricing catalog for standard cloud resources.
